...
# 
# Provides to the diff summary field an automatic summary of what was changed,
# by excerpting the actual diff text.
...
# Build a nice short single-line summary of a diff from diff text provided.
{ global $nl;
  ...
  # Build whole summary string by adding everything; cut down to 100 UTF8 chars.
  $summary = 'AutoSum: '.$prefix_add.$string_add.$sep_to_minus.$prefix_del.
                                                                    $string_del;
